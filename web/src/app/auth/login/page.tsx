...
export default function LoginPage() {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-primary/5 via-background to-secondary/5 flex items-center justify-center p-4">
      ...
      <Card className="w-full max-w-md mt-8 border-gray-300 shadow-lg p-2 mb-10">
        ...
        <CardContent className="space-y-6">
          ...
          <Button className="w-full h-11 bg-gray-800 text-white hover:bg-gray-700" asChild>
          ...
          <div className="text-center text-sm pb-20 pt-5">
